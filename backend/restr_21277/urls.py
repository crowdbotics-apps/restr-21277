...
admin.site.site_header = "restr"
admin.site.site_title = "restr Admin Portal"
admin.site.index_title = "restr Admin"

# swagger
api_info = openapi.Info(
    title="restr API",
    default_version="v1",
    description="API documentation for restr App",
)
